<div class="card shadow-lg">
    <div class="card-body">
     <h2 class="card-title">Attach payments to tenant (Only tenants with property assignments are shown)</h2>


     <form class="row" method="POST" action="{{ route('RecordPayment') }}">
      @csrf
      ...
      <div class="col-md-12 mt-3 mb-3">
       ...
       <select name="Tenant" class="form-control" required>
        @isset($Tenants)
         @foreach ($Tenants->unique('tenant') as $data)
