<div class="modal fade" id="DefAmounts_a" aria-hidden="true" aria-labelledby="Defaulter_aLabel" tabindex="-1">
    <div class="modal-dialog modal-fullscreen	">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="Defaulter_aLabel">Tabular view of total defaulted amount  per month
